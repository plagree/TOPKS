...
public class TOPKSSearcherTest {
  ...
  public void testSearchQuery() {
    // We test the termination condition of the TOPKS algorithm at each new
    // visited user
    searcher.setSkippedTests(20);
  ...
  public void testTerminationCondition() {
    ...
    searcher.setSkippedTests(1);

    // Query q="style" by seeker s=1 with skippedTests=1 (termination test at every iteration)
    List<String> query = new ArrayList<String>();
    query.add("style");

    JsonObject jsonResults = searcher.executeQuery(1, query, 2, 200, 200, 0f, false);
  ...
  public void testPrefix() {
    ...
    JsonObject jsonResults = searcher.executeQuery(seeker, query, k, t, nNeigh, alpha, false);
  ...
  public void testAlphaNonZero() {
    ...
    JsonObject jsonResults = searcher.executeQuery(
            8, query, 5, 100, 200, 0.44444444f, false);
